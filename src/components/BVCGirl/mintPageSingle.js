...
import { connect } from "../../redux/blockchain/blockchain_girl/blockchainActions"
import { fetchData } from "../../redux/data/data_girl/dataActions";
...
function BVCGuyMintSingle() {
  ...
  const getConfig = async () => {
    const configResponse = await fetch("/config/BVCGirl_config/config.json", {
      headers: {
  ...
  return (
    ...
    >
      ...
      <s.Container flex={1} jc={"center"} ai={"center"}>
          <StyledImgHsq alt={"gif"} src={"img/Teaser.png"}/>
